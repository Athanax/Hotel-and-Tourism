...
@section('content')
    ...
    <section class="welcome-area">
        <div class="welcome-slides owl-carousel">
            ...
            <div class="single-welcome-slide bg-img bg-overlay" style="background-image: url(/storage/img/bg-img/16.jpg);" data-img-url="/storage/img/bg-img/16.jpg">
                <!-- Welcome Content -->
                        ...
                        <div class="row h-100 align-items-center">
                            ...
                            <div class="col-12">
                                <div class="welcome-text text-center">
                                    <h6 data-animation="fadeInLeft" data-delay="200ms">Be a traveller not a tourist</h6>
                                    <h2 data-animation="fadeInLeft" data-delay="500ms">Mamaland</h2>
            ...
            <!-- Single Welcome Slide -->
            <div class="single-welcome-slide bg-img bg-overlay" style="background-image: url(/storage/img/bg-img/17.jpg);" data-img-url="/storage/img/bg-img/17.jpg">
                <!-- Welcome Content -->
                <div class="welcome-content h-100">
                    <div class="container h-100">
                        <div class="row h-100 align-items-center">
                            ...
                            <div class="col-12">
                                <div class="welcome-text text-center">
                                    <h6 data-animation="fadeInUp" data-delay="200ms">Be a traveller not a tourist</h6>
                                    <h2 data-animation="fadeInUp" data-delay="500ms">Mamaland</h2>
            ...
            <!-- Single Welcome Slide -->
            <div class="single-welcome-slide bg-img bg-overlay" style="background-image: url(/storage/img/bg-img/18.jpg);" data-img-url="/storage/img/bg-img/18.jpg">
                <!-- Welcome Content -->
                <div class="welcome-content h-100">
                    <div class="container h-100">
                        <div class="row h-100 align-items-center">
                            ...
                            <div class="col-12">
                                <div class="welcome-text text-center">
                                    <h6 data-animation="fadeInDown" data-delay="200ms">Be a traveller not a tourist</h6>
                                    <h2 data-animation="fadeInDown" data-delay="500ms">Mamaland</h2>
            ...
            <div class="row align-items-center">
                <div class="col-12 col-lg-6">
                    ...
                    <div class="section-heading wow fadeInUp" data-wow-delay="100ms">
                        <h6>About Us</h6>
                        <h2>Welcome to <br>Mamaland</h2>
                    </div>
                    <div class="about-us-content mb-100">
                        <h5 class="wow fadeInUp" data-wow-delay="300ms">With over 340 hotels and 500 attraction sites world wide worldwide, Our hotels offer a wide variety of hotels catering for a perfect stay no matter where your destination.</h5>
                        <p class="wow fadeInUp" data-wow-delay="400ms">Manager: <span>Athanas wambua</span></p>
                        ...
                        <div class="row no-gutters">
                            <div class="col-6">
                                <div class="single-thumb">
                                    <img src="/storage/img/bg-img/13.jpg" alt="">
                                </div>
                                <div class="single-thumb">
                                    <img src="/storage/img/bg-img/14.jpg" alt="">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="single-thumb">
                                    <img src="/storage/img/bg-img/15.jpg" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row align-items-center">
                <div class="col-12 col-md-6">
                    <div class="testimonial-thumbnail owl-carousel mb-100">
                        <img src="/storage/img/bg-img/10.jpg" alt="">
                        <img src="/storage/img/bg-img/11.jpg" alt="">
                    </div>
                </div>
    ...
    <!-- Projects Area Start -->
    <section class="roberto-project-area" style="">
        <!-- Projects Slide -->
        <div class="projects-slides owl-carousel">
            <!-- Single Project Slide -->
            <div class="single-project-slide active bg-img" style="background-image: url(/storage/img/bg-img/5.jpg);">
                <!-- Project Text -->
            ...
            <!-- Single Project Slide -->
            <div class="single-project-slide bg-img" style="background-image: url(/storage/img/bg-img/6.jpg);">
                <!-- Project Text -->
                <div class="project-content">
                    <div class="text">
                        <h6>Entertaiment</h6>
            ...
            <!-- Single Project Slide -->
            <div class="single-project-slide bg-img" style="background-image: url(/storage/img/bg-img/7.jpg);">
                <!-- Project Text -->
                <div class="project-content">
                    <div class="text">
                        <h6>Entertaiment</h6>
            ...
            <!-- Single Project Slide -->
            <div class="single-project-slide bg-img" style="background-image: url(/storage/img/bg-img/8.jpg);">
                <!-- Project Text -->
                <div class="project-content">
                    <div class="text">
                        <h6>Entertaiment</h6>
            ...
            <!-- Single Project Slide -->
            <div class="single-project-slide bg-img" style="background-image: url(/storage/img/bg-img/9.jpg);">
                <!-- Project Text -->
                <div class="project-content">
                    <div class="text">
                        <h6>Entertaiment</h6>
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-post-area mb-100 wow fadeInUp" data-wow-delay="300ms">
                        <a href="#" class="post-thumbnail"><img src="/storage/img/bg-img/2.jpg" alt=""></a>
                        <!-- Post Meta -->
                        <div class="post-meta">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-post-area mb-100 wow fadeInUp" data-wow-delay="500ms">
                        <a href="#" class="post-thumbnail"><img src="/storage/img/bg-img/3.jpg" alt=""></a>
                        <!-- Post Meta -->
                        <div class="post-meta">
                            <a href="#" class="post-date">Jan 02, 2019</a>
                            <a href="#" class="post-catagory">Event</a>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-post-area mb-100 wow fadeInUp" data-wow-delay="700ms">
                        <a href="#" class="post-thumbnail"><img src="/storage/img/bg-img/4.jpg" alt=""></a>
                        <!-- Post Meta -->
                        <div class="post-meta">
                            <a href="#" class="post-date">Jan 02, 2019</a>
                            <a href="#" class="post-catagory">Event</a>
                ...
                <div class="row align-items-center">
                    <div class="col-12 col-md-7">
                        <div class="cta-text mb-50">
                            ...
                            <h6>Contact +254702970057</h6>
                            <h6>Email info@mamaland.com</h6>

...
<section class="main__middle__container " style="margin-top:50px;">
    <div class="container">
        <div class="row justify-content-center col-md-offset-2">           
            <div class="col-md-10">
            <small>Just a few steps and all is done</small>
            <form name="form_1" action="{{ route('booksites.store') }}" method="post">
                {{ csrf_field() }}
                <fieldset>
                    <legend>Book now - {{$site->name}}</legend>
                    @if (!Auth::user())
                    <div class="row" style="padding-top:0; padding-bottom:0">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="" for="">Second Name</label>
                                <input required class="form-control" type="text"  name="s_name">
                            </div>
                        </div>
                    </div>
                    <div class="row" style="padding-top:0; padding-bottom:0">
                    ...
                    <div class="row" style="padding-top:0; padding-bottom:0">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number"  name="address">
                            </div>
                            
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="" for="">State/Town/City</label>
                    ...
                    <div class="row" style="padding-top:0; padding-bottom:0">
                        ...
                        <div class="col-md-8">
                            <input required type="number" min="0" placeholder="1234567890" class="form-control" name="id_no">
                        </div>
                    </div>
                    ...
                    <div class="row" style="padding-top:0; padding-bottom:0">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input placeholder="Type number of children..." id="child" required class="form-control" type="number" min="0"  name="child">
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input placeholder="Type number of adults..." id="adult" required class="form-control" type="number" min="0"  name="adult">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row" style="padding-top:0; padding-bottom:0">
                        ...
                        <div class="col-md-8">
                            <input id="duration" required type="number" min="0" placeholder="2" class="form-control" name="duration">
                        </div>
                    </div>
                    ...
                    <div class="row" style="padding-top:0; padding-bottom:0">
                        ...
                        <div class="col-md-8">
                            <h6><input class="tcost" style="border: none; width: 100px; font-size: 25px" type="text" name="amount" id="min-amount" value="$0.00" readonly="readonly"></h6>
                        </div>
                    </div>
                    ...
                    <br>
                    <input type="hidden" class="form-control" value="{{ $site->id }}" name="site_id">
                    <input type="hidden" class="form-control" name="site_name" value="{{ $site->name }}">
